...
function getConfigValidationErrors(config, { requireExcel = true, requireAdo = false } = {}) {
  const errors = [];
  ...
  const requiredFields = [
    ...
    ...(requireExcel ? EXCEL_REQUIRED_FIELDS : []),
    ...(requireAdo ? ADO_REQUIRED_FIELDS : [])
  ];
